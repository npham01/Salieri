...
const char * LIB_PATH_VALUE   = "/home/NPham/project/portaudio/lib/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/NPham/project/portaudio/lib/.libs:/usr/local/lib:/usr/local/bin:";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/home/NPham/project/portaudio/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/NPham/project/portaudio/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
